...
public class LoginToSalesforce_2{
...
@Test
public static void LoginToSalesForce_2() throws Exception

{

logger = reports.startTest("LoginToSalesForce_2");

String data[][] = getDataInput("C:\\Users\\senid\\Desktop\\SELENIUM DOCS\\TestData XL Sheets","LoginToSalesForce_2.xls","LoginToSalesForce_2");
