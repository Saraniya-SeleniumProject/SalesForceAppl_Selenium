...
@Test
public LoginErrorMessage_1() throws Exception

{

logger = reports.startTest("LoginErrorMessage_1");

String data[][] = getDataInput("C:\\Users\\senid\\Desktop\\SELENIUM DOCS\\TestData XL Sheets","LoginErrorMessage_1.xls","LoginErrorMessage_1");
...
WebElement ActualErrormessage = driver.findElement(By.xpath("//div[@id='error']"));
