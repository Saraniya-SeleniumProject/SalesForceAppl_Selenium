...
public class SelectLogoutoptionfromUserMenuforUsernameDropdown{
...
@Test
public SelectLogoutoptionfromUserMenuforUsernameDropdown() throws Exception

{

logger = reports.startTest("SelectLogoutoptionfromUserMenuforUsernameDropdown");

String data[][] = getDataInput("C:\\Users\\senid\\Desktop\\SELENIUM DOCS\\TestData XL Sheets","SelectLogoutoptionfromUserMenuforUsernameDropdown.xls","SelectLogoutOption");
...
WebElement logoutSubOption = driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[1]/table[1]/tbody[1]/tr[1]/td[3]/div[1]/div[3]/div[1]/div[1]/div[2]/div[3]/a[5]"));
logoutSubOption.click();

WebElement LoginPage = driver.findElement(By.id("Wrapper"));
