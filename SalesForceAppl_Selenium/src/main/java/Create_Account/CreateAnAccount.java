...
logger = reports.startTest("CreateAnAccount");

String data[][] = getDataInput("C:\\Users\\senid\\Desktop\\SELENIUMDOCS\\TestDataXLSheets","CreateAnAccount.xls","CreateAnAccount");
...
LightningExperiencePopUp.click();
 ...
 WebElement NewAccountsLink = driver.findElement(By.xpath("//input[@name='new']"));
