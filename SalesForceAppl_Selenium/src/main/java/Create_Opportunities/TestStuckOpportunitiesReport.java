...
public class TestStuckOpportunitiesReport{
...
@Test
public TestStuckOpportunitiesReport() throws IOException

{

logger = reports.startTest("TestStuckOpportunitiesReport");

String data[][] = getDataInput("C:\\Users\\senid\\Desktop\\SELENIUMDOCS\\TestDataXLSheets","TestStuckOpportunitiesReport.xls","TestStuckOpportunitiesReport");
...
WebElement StuckOpportunitiesReport = driver.findElement(By.xpath("//a[contains(text(),'Stuck Opportunities')]"));
