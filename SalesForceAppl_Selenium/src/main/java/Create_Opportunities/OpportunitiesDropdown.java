...
public class OpportunitiesDropdown{
...
@Test
public OpportunitiesDropdown() throws IOException

{

logger = reports.startTest("OpportunitiesDropdown");

String data[][] = getDataInput("C:\\Users\\senid\\Desktop\\SELENIUMDOCS\\TestDataXLSheets","OpportunitiesDropdown.xls","OpportunitiesDropdown");
...
WebElement OpportunitiesDropDownoptions = driver.findElement(By.cssSelector("#fcf"));
	System.out.println(OpportunitiesDropDownoptions.getText());
