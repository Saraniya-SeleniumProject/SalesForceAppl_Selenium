...
public class TestQuarterlySummaryReport{
...
@Test
public TestQuarterlySummaryReport() throws IOException

{

logger = reports.startTest("TestQuarterlySummaryReport");

String data[][] = getDataInput("C:\\Users\\senid\\Desktop\\SELENIUMDOCS\\TestDataXLSheets","TestQuarterlySummaryReport.xls","TestQuarterlySummaryReport");
...
WebElement QuarterlySummarySection = driver.findElement(By.xpath("//div[@class='toolsContentRight']//div[@class='bSubBlock brandSecondaryBrd secondaryPalette']"));
if (QuarterlySummarySection.isSelected())
{
	 @SuppressWarnings("unused")
	WebElement IntervalValue= driver.findElement(By.xpath("//label[contains(text(),'Interval:')]"));
    Select Intervaloption = new Select(driver.findElement(By.id("quarter_q")));
    Intervaloption.selectByValue("next1");
     
     @SuppressWarnings("unused")
	WebElement IncludeValue = driver.findElement(By.xpath("//label[contains(text(),'Include:')]"));
	    Select Includeoption = new Select(driver.findElement(By.id("open")));
	     Includeoption.selectByValue("all");
