...
public class TestOpportunityPipelineReport{
...
@Test
public TestOpportunityPipelineReport() throws IOException

{

logger = reports.startTest("TestOpportunityPipelineReport");

String data[][] = getDataInput("C:\\Users\\senid\\Desktop\\SELENIUMDOCS\\TestDataXLSheets","TestOpportunityPipelineReport.xls","TestOpportunityPipelineReport");
...
WebElement OpportunityPipelineReport = driver.findElement(By.xpath("//a[contains(text(),'Opportunity Pipeline')]"));
