...
public class CreateNewViewInTheContactPage{
...
@Test
public CreateNewViewInTheContactPage() throws IOException

{

logger = reports.startTest("CreateNewViewInTheContactPage");

String data[][] = getDataInput("C:\\Users\\senid\\Desktop\\SELENIUMDOCS\\TestDataXLSheets","CreateNewViewInTheContactPage.xls","CreateNewViewInTheContactPage");
...
String ViewName_data = data[3][2];
enter_data_textbox3(ViewName,ViewName_data,"ViewName");

WebElement ViewUniqueName = driver.findElement(By.id("devname"));
ViewUniqueName.getText();

String UniqueName = ViewName.getText();

if (ViewUniqueName.getText()== UniqueName)
{
