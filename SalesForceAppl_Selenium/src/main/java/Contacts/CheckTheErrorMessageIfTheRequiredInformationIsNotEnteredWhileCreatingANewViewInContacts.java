...
public class CheckTheErrorMessageIfTheRequiredInformationIsNotEnteredWhileCreatingANewViewInContacts{
...
@Test
public CheckTheErrorMessageIfTheRequiredInformationIsNotEnteredWhileCreatingANewViewInContacts() throws IOException,InterruptedException

{

logger = reports.startTest("CheckTheErrorMessageIfTheRequiredInformationIsNotEnteredWhileCreatingANewViewInContacts");

String data[][] = getDataInput("C:\\Users\\senid\\Desktop\\SELENIUMDOCS\\TestDataXLSheets","CheckTheErrorMessageIfTheRequiredInformationIsNotEnteredWhileCreatingANewViewInContacts.xls","ChecckTheErrorMessage");
...
String ViewUniqueName_data = data[3][2];
enter_data_textbox3(ViewUniqueName,ViewUniqueName_data,"ViewUniqueName");


WebElement SaveButton = driver.findElement(By.xpath("//div[contains(@class,'pbBottomButtons')]//input[1]//div[@class='pbBottomButtons']//input[@name='save']"));
SaveButton.click();

WebElement actualErrorMessage = driver.findElement(By.xpath("//div[contains(text(),'You must enter a value')]"));
