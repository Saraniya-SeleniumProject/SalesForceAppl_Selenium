...
public class CheckRecentlyCreatedContactInTheContactPage{
...
@Test
public CheckRecentlyCreatedContactInTheContactPage() throws IOException

{

logger = reports.startTest("CheckRecentlyCreatedContactInTheContactPage");

String data[][] = getDataInput("C:\\Users\\senid\\Desktop\\SELENIUMDOCS\\TestDataXLSheets","CheckRecentlyCreatedContactInTheContactPage.xls","CheckRecentlyCreatedContact");
...
Select RecentContactDropdown = new Select(driver.findElement(By.xpath("//select[@id='hotlist_mode']")));
RecentContactDropdown.selectByValue("2");
