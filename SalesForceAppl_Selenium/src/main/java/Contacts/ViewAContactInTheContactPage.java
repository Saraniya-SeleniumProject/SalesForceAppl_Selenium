...
public class ViewAContactInTheContactPage{
...
@Test
public ViewAContactInTheContactPage() throws IOException

{

logger = reports.startTest("ViewAContactInTheContactPage");

String data[][] = getDataInput("C:\\Users\\senid\\Desktop\\SELENIUMDOCS\\TestDataXLSheets","ViewAContactInTheContactPage.xls","ViewAContactInTheContactPage");
...
WebElement ContactNameAsLinkText = driver.findElement(By.linkText("abcd"));
ContactNameAsLinkText.click();
