...
public class CheckTheCancelButtonWorksFineInCreateNewView{
...
@Test
public CheckTheCancelButtonWorksFineInCreateNewView() throws IOException

{

logger = reports.startTest("CheckTheCancelButtonWorksFineInCreateNewView");

String data[][] = getDataInput("C:\\Users\\senid\\Desktop\\SELENIUMDOCS\\TestDataXLSheets","CheckTheCancelButtonWorksFineInCreateNewView.xls","CheckTheCancelButton");
...
String ViewUniqueName_data = data[4][2];
enter_data_textbox4(ViewUniqueName,ViewUniqueName_data,"ViewUniqueName");
