...
public class ValidateLeadsSelectViewDropdownContents{
...
@Test
public ValidateLeadsSelectViewDropdownContents() throws IOException

{

logger = reports.startTest("ListItemTodaysLeadswork");

String data[][] = getDataInput("C:\\Users\\senid\\Desktop\\SELENIUMDOCS\\TestDataXLSheets","ValidateLeadsSelectViewDropdownContents.xls","ValidateLeadsSelectViewDropdownContents");
...
WebElement LeadsDropDownoptions = driver.findElement(By.cssSelector("#fcf"));
	System.out.println(LeadsDropDownoptions.getText());
