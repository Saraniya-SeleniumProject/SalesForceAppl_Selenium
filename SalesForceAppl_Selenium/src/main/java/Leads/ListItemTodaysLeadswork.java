...
public class ListItemTodaysLeadswork{
...
@Test
public ListItemTodaysLeadswork() throws IOException

{

logger = reports.startTest("ListItemTodaysLeadswork");

String data[][] = getDataInput("C:\\Users\\senid\\Desktop\\SELENIUMDOCS\\TestDataXLSheets","ListItemTodaysLeadswork.xls","ListItemTodaysLeadswork");
...
WebElement ViewLabel = driver.findElement(By.xpath("//span[@class='bFilter']//label[contains(text(),'View:')]"));
Select TodaysLeadoption = new Select(driver.findElement(By.id("fcf")));
TodaysLeadoption.selectByIndex(3);
