...
@Test
public CheckLeadsTab() throws IOException

{

logger = reports.startTest("CheckLeadsTab");

String data[][] = getDataInput("C:\\Users\\senid\\Desktop\\SELENIUMDOCS\\TestDataXLSheets","CheckLeadsTab.xls","CheckLeadsTab");
